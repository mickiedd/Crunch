...
/**
 * Actor component that manages a player's inventory items, including purchase,
 * activation, selling, stacking, slotting and GAS hooks. Orchestrates client-server
 * RPCs for authoritative item actions and emits delegates for UI updates.
 */
